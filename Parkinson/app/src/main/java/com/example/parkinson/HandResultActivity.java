...
public class HandResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hand_result);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (result == 0) {
                                res="您可能患有帕金森病（可信度86.1%）,请到专业医院抓紧时间诊疗";
                                //处理result为0的情况
                            } else if (result == 1) {
                                //处理result为1的情况
                                res="恭喜您没有帕金森病（可信度97.6%），请持续关注身体健康";
                            }
